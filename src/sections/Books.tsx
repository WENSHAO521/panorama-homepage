...
export default function Books() {
  ...
  return (
    <section id="books" className="py-20 lg:py-28 bg-neutral-50">
      <div className="container mx-auto px-6">
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 mb-3">
                    <span className={`px-2 py-1 text-xs font-medium rounded ${
                      ...
                      {book.category === 'monograph' ? 'Monograph' :
                       book.category === 'collection' ? 'Collection' : 'Textbook'}
                    </span>
                  </div>
        ...
        >
          <button className="inline-flex items-center gap-2 px-6 py-3 border-2 border-[#A51C30] text-[#A51C30] font-medium rounded-lg hover:bg-[#A51C30] hover:text-white transition-colors">
