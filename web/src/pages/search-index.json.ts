...
const corePages: SearchRecord[] = [
  ...
  { type: 'page', title: 'Responsible Research Assessment', description: "Panorama Scholarly Group's commitment to responsible research assessment and the principles of the San Francisco Declaration on Research Assessment.", url: '/standards/research-assessment/', keywords: ['DORA', 'research assessment', 'responsible metrics', 'research evaluation'] },
